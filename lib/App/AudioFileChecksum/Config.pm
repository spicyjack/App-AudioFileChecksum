##########################################
# package App::AudioFileChecksum::Config #
##########################################
package App::AudioFileChecksum::Config;

=head1 NAME

App::AudioFileChecksum::Config
...
Wrapper around L<Getopt::Long>, which also provides generic getters/setters
for reading/writing script configuration options.
...
Creates the L<App::AudioFileChecksum::Config> object, parses options from the
...
key does not exist in the L<App::AudioFileChecksum::Config> object.
...
Sets in the L<App::AudioFileChecksum::Config> object the key/value pair passed in
as arguments.  Returns the old value if the key already existed in the
L<App::AudioFileChecksum::Config> object, or C<undef> otherwise.
...
You can find documentation for this script with the perldoc command.
    ...
    perldoc App::AudioFileChecksum::Config
